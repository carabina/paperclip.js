  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c10 = function(children) { 
            var children = trimTextExpressions(children);

            if (children.length > 1 && hasBlock(children) && onlyTextAndBlocks(children)) {
              return new ArrayExpression(new ParametersExpression([new CombinedBlockExpression(children)]));
            } else {
              return new ArrayExpression(new ParametersExpression(children));
            }
          },
        peg$c11 = "<!--",
    ...
    var CombinedBlockExpression    = require("./ast/combinedBlockBinding");
    ...
    function hasBlock (expressions) {
      return !!expressions.filter(function (expr) {
        return expr.type === "blockBinding";
      }).length;
    }

    function onlyTextAndBlocks (expressions) {
      return expressions.every(function (expr) {
        return expr.type === "blockBinding" || expr.type === "textNode";
      });
    }
